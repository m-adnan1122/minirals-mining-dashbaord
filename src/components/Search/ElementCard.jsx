 ...
 */
export function ElementCard({ data, selected = false, onClick, size = "md" }) {
  const ORANGE = "#FF7A00"
  const dims = size === "sm" ? { w: "65px", h: 96, radius: "20", symbolFs: "30px" } : { w: 100, h: 114, radius: 14, symbolFs: 34 }
  ...
  return (
    <Box
      ...
      sx={{
        ...
        borderRadius: `0px 0px ${dims.radius}px 0px`,
        position: "relative",
        bgcolor: "#fff",
        color: ORANGE,
